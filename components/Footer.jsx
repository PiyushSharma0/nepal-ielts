        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-row items-center mb-8">
            <img
              src="OIN.png"
              alt="logo"
              class="w-28 object-contain xl:block"
            />
            <img
              src="OPN.png"
              alt="logo"
              class="w-40 object-contain xl:block"
            />
          </div>
          ...
          <div className="flex flex-row space-x-4 mb-8">
            <Link href="tel:+977 9802335996" target="_blank">
              <IoCall className="text-5xl text-blue-400 hover:cursor-pointer" />
            </Link>
            <Link href="mailto:info@onlineclassnepal.com.np" target="_blank">
              <MdEmail className="text-5xl text-blue-400 hover:cursor-pointer" />
            </Link>
            ...
            <Link
              href="https://www.instagram.com/online_ielts_nepal/"
              target="_blank"
            >
              <svg
